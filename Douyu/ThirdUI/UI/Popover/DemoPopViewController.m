...
@interface DemoPopViewController () <UIPopoverPresentationControllerDelegate>
{
...
- (void)popView
{
    ...
    //content尺寸
    _popVC.preferredContentSize = CGSizeMake(400, 600);
    ...
    //如果parent view controller不是navigationController，则需要[self presentViewController];
    [self.navigationController presentViewController:_popVC animated:YES completion:nil];
}
